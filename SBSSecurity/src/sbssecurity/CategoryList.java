...
public class CategoryList extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        categorytable.setFont(new java.awt.Font("Sitka Heading", 0, 18)); // NOI18N
        categorytable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "S.No.", "Category Name", "Salary", "description"
            }
        ) {
        ...
        categorytable.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
    ...
    private void displayData(){
        ...
        for(Category c: al){
            Object o[] = {c.getCid(),c.getCname(),c.getSalary(),c.getDescription()};
            dtm.addRow(o);
        }
